...
internal static partial class HlslKnownKeywords
{
    ...
    private static HashSet<string> BuildKnownKeywordsMap()
    {
        ...
        [
            ...
            "maxvertexcount", "TriangleStream", "Buffer", "ByteAddressBuffer", "AppendStructuredBuffer",
            "ConsumeStructuredBuffer", "InputPatch", "OutputPatch", "RWBuffer", "RWByteAddressBuffer",
            "RWStructuredBuffer", "RWTexture1D", "RWTexture1DArray", "RWTexture2D", "RWTexture2DArray",
            "RWTexture3D", "StructuredBuffer", "Texture1D", "Texture1DArray", "Texture2D", "Texture2DArray",
